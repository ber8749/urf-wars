...
export class PhysicsWorld {
  ...
  constructor() {
    ...
    // Use centralized physics config for gravity
  ...
  createKinematicBody(id: string, position: THREE.Vector3): RigidBody {
    const bodyDesc =
  ...
  isGrounded(
    position: THREE.Vector3,
    checkDistance: number = PHYSICS_CONFIG.GROUND_CHECK_DISTANCE
  ): boolean {
